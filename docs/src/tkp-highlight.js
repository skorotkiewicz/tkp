hljs.registerLanguage('tkp', (hljs) => {
  const KEYWORDS = {
    ...
    built_in: 'toki kute lili_nanpa wawa_nanpa suli_nanpa nanpa_ante kipisi_ante suli_ijo lipu_lukin lipu_sitelen lipu_sin lipu_lon sitelen_pali toki_pakala'
  };
